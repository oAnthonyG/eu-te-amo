    ...
    <section>
      ...
      <div className={styles.container}>
        ...
        <p>❤ O dia mais importante da minha vida, onde eu pela
          primeira vez vi a mulher mais linda desse mundo, e tive a
          certeza de estar apaixonado.</p>
      </div>
      <div className={styles.container}>
        <figure>
        ...
        <p>❤ Quando andamos de mãos dadas eu me senti incrivel,
          pode parecer cliche mas mas naquele momento
          ja sentia que nunca mais soltaria.</p>
      </div>
      <div className={styles.container}>
        <figure>
        ...
        <p>❤ Aquele sorriso, aquele maravilhoso sorriso fez eu ficar
          todo caidinho por você e que me deixou viciado querendo
          ver todos os dias.</p>
      </div>
      <div className={styles.container}>
        <figure>
        ...
        <p>❤ Nesse momento meu mundo virou de cabeça pra baixo
          e uma chama dentro de mim começou a acender fortona.</p>
      </div>
      <div className={styles.container}>
        <figure>
        ...
        <p>❤ Esse dia foi incrivel, tomamos chuva e ficamos molhados mas
          foi muito divertido e onde as foto com linguinha começaram.</p>
      </div>
      <div className={styles.container}>
        <figure>
      ...
      <div className={styles.container}>
        ...
        <p>❤ Foi uma festa muito divertida e foi onde eu te pedi em namoro
          e você fico me enrolando para aceitar e no final aceitou né,
          menino irresitível esse ai.</p>
      </div>
      <div className={styles.container}>
        <figure>
        ...
        <p>❤ Um dos dias mais diferentes da minha vida pois não ia a festas
          mas vc logo no começou ja me tirou da zona de conforto e foi onde
          eu tive certeza do que estava fazendo te olhar de
          longe se divertindo era minha alegria.</p>
      </div>
      <div className={styles.container}>
        <figure>
      ...
      <div className={styles.container}>
        ...
        <p>❤ Um dos dias mais felizes da minha vida se não o
          mais onde eu te mostrei que queria algo sério e que demonstrava
          ficar com você para todo o sempre dali em diante as coisas
          estavam 100% sérias.</p>
      </div>
